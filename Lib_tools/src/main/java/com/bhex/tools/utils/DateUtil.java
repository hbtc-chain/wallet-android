...
public class DateUtil {
    ...
    public static final String  DATA_TIME_STYLE = "yyyy/MM/dd HH:mm:ss";
    ...
    public static String formatDateToString(Date aDate, String pattern) {
        if (aDate == null)
            return "";
        formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        return formatter.format(aDate);
    ...
    public static String getDateFromatStr(long date, String dateForat) {
        String shortDate = null;
        SimpleDateFormat formatter = new SimpleDateFormat(dateForat);
        try {
            Long time = new Long(date * 1000);
            shortDate = formatter.format(time);
        } catch (Exception e) {
    ...
    public static String getDateFromat2Str(long date, String dateForat) {
        String shortDate = null;
        SimpleDateFormat formatter = new SimpleDateFormat(dateForat);
        try {
...
//            shortDate = formatter.format(time);
     ...
     * @return long转string
     */
    public static String transTimeWithPattern(long t,String pattern){
