...
import com.bhex.lib_qr.camera.AutoFocusCallback;
...
import com.bhex.lib_qr.util.QRCodeProduceUtils;
...
public class XQRCode {
    ...
    public static Bitmap createQRCodeWithLogo(String contents, Bitmap logo) {
        return QRCodeProduceUtils.create(contents, QRCodeProduceUtils.QRCODE_BITMAP_MAX_SIZE, QRCodeProduceUtils.QRCODE_BITMAP_MAX_SIZE, logo);
    }
