package com.bhex.lib.uikit.widget.bar;
...
import com.bhex.tools.utils.ThemeUtils;
...
public class Cookie extends LinearLayout {
    ...
    public void setParams(final CookieBar.Params params) {
        if (params != null) {
            ...
            int padding = ThemeUtils.resolveDimension(getContext(), R.attr.config_content_spacing_horizontal);
