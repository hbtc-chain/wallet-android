package com.bhex.lib.uikit.widget.load;
...
public class HwLoadingView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mSize = (int) ta.getDimension(R.styleable.HW_Loading_View_hlv_size, PixelUtils.dp2px(context, 100));
        setSize(mSize);

        mColor = ta.getColor(R.styleable.HW_Loading_View_hlv_color, Color.parseColor("#3375E0"));
        setColor(mColor);
