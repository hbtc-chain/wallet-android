...
public class RecycleViewExtDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RecycleViewExtDivider(Context context, int orientation) {
     ...
     */
    public RecycleViewExtDivider(Context context, int orientation, int drawableId) {
     ...
     */
    public RecycleViewExtDivider(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            float left = child.getLeft()+mPaddingLeft;
            float right = child.getRight();
            float top = child.getBottom()-10;
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childSize-1; i++) {
            ...
            final int left = child.getLeft()+mPaddingLeft;
            final int right = child.getRight()-mPaddingRight;
